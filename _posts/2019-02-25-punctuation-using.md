...
**，**:    句内点号的一种，表示一般停顿。
  ...
  ##### 用于较长宾语之前
    ...
    - 有的考古工作者认为，南方古猿生存在上新世至更新世的初期和中期。

  ##### 用于较长主语、谓语或者宾语之间

    - 母亲沉痛的诉说，以及亲眼见到的事实，都启发了我年幼时期迫求真理的思想。

    - 那姑娘头戴一顶草帽，身穿一条绿色胡裙子，腰间还系着一根橙色胡腰带。
...
**、**:    一种句内点号，表示并列词语之间或者顺序词语之后的停顿。
  ...
  ##### 用于次序词之后
    ...
    - 我准备两个问题：一，逻辑学是什么？二，怎样学好逻辑学？

    - 风格的具体内容有以下四点：甲、题材；乙、用字；丙、表达；丁、色彩。

  ##### 相近两数字连用表概数不用顿号

    - 农业是国民经济的基础，也是二三产业的基础。
...
**“” ‘’ 「」**:    标号的一种，标示引用指出的成分。（**「」** 为直角引号）
  ...
  ##### 独立成段的引文如果只有一段前后都用引号，不止一段第一段前用引号最后一段后用引号。
...
```
  ...
  ##### 标示话题转变
    ...
    - “好香的饭菜，——听到风声了吗？”赵七爷低声说道。

  ##### 标示中断或间隔

    - “班长他牺——”小马还没说完就大哭起来。

    - “亲爱的妈妈，你知不知道我多爱你，——还有你，我的孩子!”
